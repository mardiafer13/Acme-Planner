...
public class ManagerTaskCreateTest extends AcmePlannerTest{
	...
	@ParameterizedTest
    @CsvFileSource(resources = "/authenticated/task/create-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
    @Order(10)
	...
	@ParameterizedTest
    @CsvFileSource(resources = "/authenticated/task/create-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
    @Order(10)
